...
def save_Jobs():
    ...
    columns = ['job_id','agency','posting_type','num_positions','business_title','civil_service_title',
    'title_classification','title_code_no','level','job_category','full_time_part_time_indicator',
    'career_level','salary_range_from','salary_range_to','salary_frequency','work_location',
    'division_work_unit','job_description','minimum_qual_requirements','preferred_skills',
    ...
    while offset<record_count:
        ...
        for index, row in jobs_list_df.iterrows():
            try:
                jobrecord.append(job_record( job_id=row['job_id'],
                                agency=row['agency'],
